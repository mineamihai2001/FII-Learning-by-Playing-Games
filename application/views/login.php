        ...
        <div id="login-frame">
            ...
            <div id="buttons" class="component">
                ...
                <div class="other-logins">
                    <button class="btn login-google button_slide">
                        <div>
                    ...
                    <button class="btn login-microsoft button_slide">
                        <div>
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="512px" style="enable-background: new 0 0 512 512" version="1.1" viewBox="0 0 512 512" width="512px" xml:space="preserve">
                                <g id="_x32_16-microsoft">
                                    <g>
                                        <rect height="215.65" style="fill: #f25022" width="215.648" x="30.905" y="30.904" />
                                        <rect height="215.65" style="fill: #7fba00" width="215.648" x="265.446" y="30.904" />
                                        <rect height="215.651" style="fill: #00a4ef" width="215.648" x="30.905" y="265.444" />
                                        <rect height="215.651" style="fill: #ffb900" width="215.648" x="265.446" y="265.444" />
                                    </g>
                                </g>
                                <g id="Layer_1" />
                            </svg>
                    ...
                    <button class="btn login-facebook button_slide">
                        <div>
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 32 32" height="32px" id="Layer_1" version="1.0" viewBox="0 0 32 32" width="32px" xml:space="preserve">
                                <g>
