...
<div id="page">
    <div id="login-frame">
        <form action="/application/action_login" method="POST" id="login-form" class="component">
            ...
            <input id="username" class="credentials" type="text" placeholder="E-mail or Username" name="username"/>
            <label for="username" style="display: none" ></label>
            <br/>
            <input id="password" class="credentials" type="password" placeholder="Password" name="password"/>
